...
area=form.getvalue('genre')
conn=sqlite3.connect('e-articles.db')
d1=conn.execute("select Aname,Description,Aid,Area,Fname from Articles A,Faculty F,Students S where A.F_email=F.F_email and ")
data1=d1.fetchall()
...
print("""                   <!--<textarea class="form-control footer-input margin-b-30" rows="6" placeholder="* Description" required name="desc"></textarea>-->
						<input type="hidden"/>
