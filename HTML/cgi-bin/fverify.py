...
d=conn.execute("select Fname,Farea from Faculty where F_email=?",(email,))
data=d.fetchall()
d1=conn.execute("select distinct Aname,Description,Aid,Sname from SArticles S,Faculty F,Students St where S.Area=F.Farea and S.S_email=St.S_email and S.status!='accepted'")
data1=d1.fetchall()
d2=conn.execute("select count(Area) from SArticles S where Area=? and S.status!='accepted'",(data[0][1],))
data2=d2.fetchall()
	...
	<body>
					...
					<div class="collapse navbar-collapse nav-collapse">
						<div class="menu-container">
							<ul class="navbar-nav navbar-nav-right">
								<li class="nav-item"><a class="nav-item-child nav-item-hover" href="fhome.py">Read Articles</a></li>
                                ...
                                <li class="nav-item"><a class="nav-item-child nav-item-hover active" href="fverify.py">Verify Articles</a></li>
		...
		<div class="parallax-window" data-parallax="scroll" data-image-src="/img/1920x1080/01.jpg">
			<div class="parallax-content container">
				<h1 class="carousel-title">HI,""",data[0][0],"""</h1>
				<p>HERE YOU HAVE A GLANCE OF ARTICLES<br/> PROPOSED BY STUDENTS FROM YOUR AREA OF SPECIALISATION<br/>IF YOU ACCEPT THE ARTICLE IT WILL BE PUBLISHED</p>
			</div>
		</div>
		<!--========== PARALLAX ==========-->

		<!--========== PAGE LAYOUT ==========-->
		<!-- Pricing --><div class="bg-color-sky-light">
								...
								<div class="wow fadeInLeft" data-wow-duration=".3" data-wow-delay=".1s">
									...
									<div class="pricing">
										...
										<ul class="list-unstyled pricing-list margin-b-50">
											...
											<li class="pricing-list-item">Proposed by:""",data1[j][3],"""</li>
										</ul>
            ...
            <div class="footer-seperator">
                <div class="content-lg container">
                    <div class="row">
					  ...
					  <form action="starticles.py" method="post">
                            <h2 class="color-white">READ ARTICLE</h2>
                            <input type="numeric" class="form-control footer-input margin-b-20" placeholder="*ARTICLE ID" name="id">
                            <button type="submit" class="btn-theme btn-theme-sm btn-base-bg text-uppercase">Read</button>
                        </form>
						</div>
						<div class="col-sm-5 sm-margin-b-30">
						  <form action="verifying.py" method="post">
                            <h2 class="color-white">GRANT PERMISSION FOR AN ARTICLE</h2>
                            <input type="numeric" class="form-control footer-input margin-b-20" placeholder="*ARTICLE ID" name="id">
                            <button type="submit" class="btn-theme btn-theme-sm btn-base-bg text-uppercase">Grant</button>
							</form>
                        </div>
                    </div>
                    <!--// end row -->
