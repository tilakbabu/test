...
d1=conn.execute("select Aname,Description,Aid,Area,Sname from SArticles A,Students S where A.S_email=S.S_email and A.status='accepted'")
data1=d1.fetchall()
d2=conn.execute("select count(*) from SArticles where status='accepted'")
data2=d2.fetchall()
					...
					<div class="collapse navbar-collapse nav-collapse">
						<div class="menu-container">
							<ul class="navbar-nav navbar-nav-right">
								...
								<li class="nav-item"><a class="nav-item-child nav-item-hover" href="fsarticles.py">Read Students Articles</a></li>
				...
				<div class="content-lg container">
					<div class="row">
					 ...
					 <div class="col-sm-5 sm-margin-b-30">
					   <form action="starticles.py" methog="post">
							<h2 class="color-white">ENTER ARTICLE ID TO READ IT</h2>
							<input name="id" type="text" class="form-control footer-input margin-b-20" placeholder="* Article ID" required>
