...
d=conn.execute("select Fname from Faculty where F_email=?",(email,))
data=d.fetchall()
d1=conn.execute("select Aname,Description,Aid,Area from Articles where F_email=?",(email,))
data1=d1.fetchall()
d2=conn.execute("select count(*) from Articles where F_email=?",(email,))
data2=d2.fetchall()
