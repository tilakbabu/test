...
d=conn.execute("select Sname from Students where S_email=?",(email,))
data=d.fetchall()
d1=conn.execute("select Aname,Description,Aid,Area,status,count1 from SArticles where S_email=?",(email,))
data1=d1.fetchall()
d2=conn.execute("select count(*) from SArticles where S_email=?",(email,))
data2=d2.fetchall()
	...
	<body>
					...
					<div class="collapse navbar-collapse nav-collapse">
						<div class="menu-container">
							<ul class="navbar-nav navbar-nav-right">
								...
								<li class="nav-item"><a class="nav-item-child nav-item-hover active" href="sprofile.py">Profile</a></li>
		...
		<div class="parallax-window" data-parallax="scroll" data-image-src="/img/1920x1080/01.jpg">
			<div class="parallax-content container">
				...
				<p>HERE YOU CAN VIEW <br/> EDIT YOUR ARTICLES WHICH ARE ALREADY PUBLISHED</p>
			</div>
		</div>
		<!--========== PARALLAX ==========-->
								...
								<div class="wow fadeInLeft" data-wow-duration=".3" data-wow-delay=".1s">
									...
									<div class="pricing">
										...
										<ul class="list-unstyled pricing-list margin-b-50">
											...
											<li class="pricing-list-item">Status:""",data1[j][4],"""</li>
                                                                                        <li class="pricing-list-item">Accepted members:""",data1[j][5],"""</li>
										</ul>
									</div>
									<!-- End Pricing -->
								</div>
