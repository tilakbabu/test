...
d5=conn.execute("select Fname from Faculty where Farea=?",(genre,))
data5=d5.fetchall()
d6=conn.execute("select count(*) from Faculty where Farea=?",(genre,))
data6=d6.fetchall()
	...
	<body>
		...
		<div class="parallax-window" data-parallax="scroll" data-image-src="/img/1920x1080/01.jpg">
			<div class="parallax-content container">
				...
				<form action="sread.py" method="post">
							<h2 class="color-white">Search By Professor</h2>
            <select name="name" class="form-control footer-input margin-b-20">
            <option>Select Professor</option>""")
for k in range(0,data6[0][0]):
    print("""<option value=""",data5[k][0],""">""",data5[k][0],"""</option>""")
