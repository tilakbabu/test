...
d1=conn.execute("select Aname,Description,Aid,Area,Fname from Articles A,Faculty F where A.F_email=F.F_email")
data1=d1.fetchall()
d2=conn.execute("select count(*) from Articles")
data2=d2.fetchall()
					...
					<div class="collapse navbar-collapse nav-collapse">
						<div class="menu-container">
							<ul class="navbar-nav navbar-nav-right">
								<li class="nav-item"><a class="nav-item-child nav-item-hover active" href="read.py">Read Articles</a></li>
								<li class="nav-item"><a class="nav-item-child nav-item-hover" href="publish.py">Publish an Article</a></li>
								<li class="nav-item"><a class="nav-item-child nav-item-hover" href="profile.py">Profile</a></li>
			...
			<div class="footer-seperator">
				<div class="content-lg container">
					...
					<!--    <div class="col-sm-5 sm-margin-b-30">
							...
							<input type="text" class="form-control footer-input margin-b-20" placeholder="*ARTICLE NAME" required>
							<select name="actype" class="form-control footer-input margin-b-20">
																	<option selected>Select Genre</option>
																		<option value="f" >Networks</option>
																		<option value="s" >DataBase</option>
																		<option value="s" >DataBase</option>
																		<option value="s" >DataBase</option>
																		<option value="s" >DataBase</option>
																</select>
							<input type="file" class="form-control footer-input margin-b-20" placeholder="*UPLOAD" required>
