    ...
    <body>
                    ...
                    <div class="collapse navbar-collapse nav-collapse">
                        <div class="menu-container">
                            <ul class="navbar-nav navbar-nav-right">
                                <li class="nav-item"><a class="nav-item-child nav-item-hover" href="shome.py">Read Articles</a></li>
								<li class="nav-item"><a class="nav-item-child nav-item-hover" href="sssearch.py">Read Students Articles</a></li>
                                <li class="nav-item"><a class="nav-item-child nav-item-hover active" href="spublish.py">Publish an Article</a></li>
        ...
        <div class="parallax-window" data-parallax="scroll" data-image-src="/img/1920x1080/01.jpg">
            <div class="parallax-content container">
                <h1 class="carousel-title">PUBLISH YOUR ARTICLES HERE</h1>
                <p>SHARING IDEAS<br/> IS THE MOST IMPORTANT THING IN LEARNING</p>
            </div>
        </div>
        <!--========== PARALLAX ==========-->
                    ...
                    <div class="row">
                       ...
                       <!-- </div>
                        ...
                        <div class="col-sm-5 sm-margin-b-30">
						  <form action="spublishing.py" method="post">
                            <h2 class="color-white">PUBLISH AN ARTICLE</h2>
                            <input type="text" class="form-control footer-input margin-b-20" placeholder="*ARTICLE NAME" required name="aname">
															<select name="aos" class="form-control footer-input margin-b-20">
								    <option selected>Select Area</option>
									<option value="Networks">Networks</option>
									<option value="DataBase" >DataBase</option>
									<option value="DataStructures" >Data Structures</option>
									<option value="DataCommunucations" >Data Communucations</option>
									<option value="Encoding" >Encoding</option>
								</select>
                            <textarea class="form-control footer-input margin-b-20" rows="25" placeholder="*start writing" required name="file"></textarea>
                            <textarea class="form-control footer-input margin-b-30" rows="3" placeholder="* Description" required name="desc"></textarea>
                            <button type="submit" class="btn-theme btn-theme-sm btn-base-bg text-uppercase">Publish</button>
                        </div>
                    </div>
                    <!--// end row -->
            <!--    </div>
