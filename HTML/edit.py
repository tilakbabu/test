                    ...
                    <div class="collapse navbar-collapse nav-collapse">
                        <div class="menu-container">
                            <ul class="navbar-nav navbar-nav-right">
                                ...
                                <li class="nav-item"><a class="nav-item-child nav-item-hover active" href="fpublish.py">Publish an Article</a></li>
                    ...
                    <div class="row">
                       ...
                       <!-- </div>
                        ...
                        <div class="col-sm-5 sm-margin-b-30">
						  <form action="fpublishing.py" method="post">
                            <h2 class="color-white">PUBLISH AN ARTICLE</h2>
                            <input type="text" class="form-control footer-input margin-b-20" placeholder="*ARTICLE NAME" value="  " required name="aname">
                            <textarea class="form-control footer-input margin-b-20" rows="25" placeholder="*start writing" value="  " required name="file"></textarea>
                            <textarea class="form-control footer-input margin-b-30" rows="3" placeholder="* Description" value="  " required name="desc"></textarea>
